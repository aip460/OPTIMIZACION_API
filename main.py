...
from optimizador import resolver_problema
...
def run():
    ...
    Label(window, image=imagen1, bd=50).pack(side='right',fill="both")
    ...
    Label(tab0, text="""
    Optimización de cortes de piezas.\n                       
                                                """).pack(anchor=NW)
    Label(tab0, text="""
    INPUTS: stocks, longitudes tanto de materias primas como resultantes.\n                       
                                                """).pack(anchor=NW)
    Label(tab0, text="""
    OUTPUTS: Secuencia de corte óptimo.\n                       
                                                """).pack(anchor=NW)
    ...
    Desarrollado en Python.\n                       
                                                """).pack(anchor=NW)
    Label(tab0, text="""
    Posibles mejoras: Introducir precios de materias y tratar de minimizar \n
     el gasto de materias primas y maximizar el de materias resultantes.""").pack(anchor=SE)
                ...
                def clicked3():
                    ...
                    if res==True:
                        ...
                        if check1 and check2:
                            ...
                            t1 = time.time()
                            sol = resolver_problema(n, L, m, w, b )
                            t2 = time.time()
                            bar['value'] = 100
                            ...
                            if sol[0]==0 or sol[0]==3: #OPTIMAL(0),FEASIBLE(3)'
                                ...
                                btn_exportar = Button(tab3, text='Exportar resultados', command=lambda: save(sol)).pack()
                    ...
                    def clicked3():
                        ...
                        if res == True:
                            ...
                            if check1 and check2:
                                ...
                                if sol[0] == 0 or sol[0] == 3: #0=optimo, 3=factible
